...
/**
     ...
     */
export function moveParticleWithCollisionAvoidance(turtle: BrownianParticleTurtle, world: Model["world"], turtles: Turtles, ) {
     ...
     */
export function isPositionValid(turtle: BrownianParticleTurtle, x: number, y: number, turtles: Turtles): boolean {
     ...
     */
export function isPositionValidOptimized(turtle: BrownianParticleTurtle, x: number, y: number, turtles: Turtles): boolean {
     ...
     */
export function moveParticleWithElasticCollision(turtle: BrownianParticleTurtle, world: Model["world"], turtles: Turtles) {
        const angle = Math.random() * 2 * Math.PI;
        const dx = turtle.stepSize * Math.cos(angle);
        const dy = turtle.stepSize * Math.sin(angle);
